  ...
  static getDerivedStateFromProps(props, state) {
    ...
    return {
      ...
      scenes: props.routes.map((route, index, self) => {
        ...
        const optionsForTransitionConfig = index !== self.length - 1 && nextDescriptor ? nextDescriptor.options : descriptor.options;
        let defaultTransitionPreset = optionsForTransitionConfig.presentation === 'modal' ? _TransitionPresets.ModalTransition : _TransitionPresets.DefaultTransition;
        const {
          ...
          cardOverlayEnabled = _reactNative.Platform.OS !== 'ios' || cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS
        } = optionsForTransitionConfig;
        const headerMode = (_descriptor$options$h = descriptor.options.headerMode) !== null && _descriptor$options$h !== void 0 ? _descriptor$options$h : !(optionsForTransitionConfig.presentation === 'modal' || cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS) && _reactNative.Platform.OS === 'ios' && descriptor.options.header === undefined ? 'float' : 'screen';
        const scene = {
          route,
          ...
          progress: {
            ...
            next: nextGesture ? getProgressFromGesture(nextGesture, state.layout, nextDescriptor) : undefined,
  ...
  render() {
    ...
    for (let i = scenes.length - 1; i >= 0; i--) {
      ...
      const {
        ...
        detachPreviousScreen = options.presentation === 'modal' || options.cardStyleInterpolator === _CardStyleInterpolators.forModalPresentationIOS ? i !== scenes.length - 1 : true
      } = options;
