  ...
  static getDerivedStateFromProps(props, state) {
    ...
    return {
      ...
      scenes: props.routes.map((route, index, self) => {
        ...
        let defaultTransitionPreset = optionsForTransitionConfig.presentation === 'modal' ? ModalTransition : DefaultTransition;
        const {
          ...
          cardOverlayEnabled = Platform.OS !== 'ios' || cardStyleInterpolator === forModalPresentationIOS
        } = optionsForTransitionConfig;
        const headerMode = (_descriptor$options$h = descriptor.options.headerMode) !== null && _descriptor$options$h !== void 0 ? _descriptor$options$h : !(optionsForTransitionConfig.presentation === 'modal' || cardStyleInterpolator === forModalPresentationIOS) && Platform.OS === 'ios' && descriptor.options.header === undefined ? 'float' : 'screen';
        const scene = {
          route,
  ...
  render() {
    ...
    for (let i = scenes.length - 1; i >= 0; i--) {
      ...
      const {
        ...
        detachPreviousScreen = options.presentation === 'modal' || options.cardStyleInterpolator === forModalPresentationIOS ? i !== scenes.length - 1 : true
      } = options;
